...
# standard errors between 1971-1985.                                        #
#############################################################################
...
cum4.nt <- (sqrt(g.powers[2]))^(-4)*(g.powers[4] +12*gam.con1[4]+12*gam.pwr1) 
...
# asymptotic (ASY) approximation between 1971-1985 for MLE lambda hat.      #
#############################################################################
...
1-CDF.SAD1(round(sarar$coefficients[1],4))   ####  sparse weights matrix:0.01776313, Wdia1: 0.01389807
