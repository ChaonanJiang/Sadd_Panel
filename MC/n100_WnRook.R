...
######### LOAD the MC results for MLE, z11 data from SAR_mle.rdata
load("SAR_mle.rdata")
...
# (dotted line) probability approximation for n=100 and Wn=rook.              #
###############################################################################
