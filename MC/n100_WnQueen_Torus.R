...
######### LOAD the MC results for MLE, z11.3 data from SAR_mle.rdata
load("SAR_mle.rdata")
...
n1 <- r2*r2   #n is 2500
N1 <- n1*T 
W1 <- cell2nb(r2,r2,type = "queen",torus = T)    #queen with torus type
...
n2 <- r3*r3   #n is 1225
N2 <- n2*T 
W2 <- cell2nb(r3,r3,type = "queen",torus = T)    #queen with torus type
