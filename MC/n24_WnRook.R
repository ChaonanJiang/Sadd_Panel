...
lines(theta.grid,p.std,typ='l',col="blue",ylim = c(0,2.5),lwd=2)  #saddlepoint
lines(theta.grid,dnorm(theta.grid,0,sqrt(asy.sigma2)),col="red",lwd=2, lty=2) #asymptotic normal
...
# approximation (continuous line) for the MLE. n=24 and Wn=Rook               #
###############################################################################
